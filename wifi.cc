...
int main (int argc, char *argv[])
{
  ...
  int mcs = 0; //-1 indicates an unset value, 0 to 11
  ...
  for (int i = 0; i < nStaA; i++)
  {
    ...
    dataRateA_str[i] = std::to_string(dataRateA[i]) + "Kb/s";
  }
  ...
  for (int i = 0; i < nStaC; i++)
  {
    ...
    dataRateC_str[i] = std::to_string(dataRateC[i]) + "Kb/s";
  }
  ...
  */
  ...
  for (int i = 0; i < nStaA; i++)
    Config::Set ("/NodeList/" + std::to_string(i) + "/DeviceList/0/$ns3::WifiNetDevice/Phy/ChannelWidth",
                 UintegerValue (channelWidthA));
  Config::Set ("/NodeList/3/DeviceList/0/$ns3::WifiNetDevice/Phy/ChannelWidth",
               UintegerValue (channelWidthA));
  for (int i = 0; i < nStaB; i++)
    Config::Set ("/NodeList/" + std::to_string(nStaA+i) + "/DeviceList/0/$ns3::WifiNetDevice/Phy/ChannelWidth",
                 UintegerValue (channelWidthB));
  Config::Set ("/NodeList/3/DeviceList/1/$ns3::WifiNetDevice/Phy/ChannelWidth",
               UintegerValue (channelWidthB));
  for (int i = 0; i < nStaC; i++)
  ...
  Config::Set ("/NodeList/3/DeviceList/2/$ns3::WifiNetDevice/Phy/ChannelWidth",
               UintegerValue (channelWidthC));
  ...
  Config::Set ("/NodeList/3/DeviceList/0/$ns3::WifiNetDevice/HeConfiguration/GuardInterval",
               TimeValue (NanoSeconds (giA)));
  for (int i = 0; i < nStaB; i++)
  ...
  Config::Set ("/NodeList/3/DeviceList/1/$ns3::WifiNetDevice/HeConfiguration/GuardInterval",
               TimeValue (NanoSeconds (giB)));
  for (int i = 0; i < nStaC; i++)
  ...
  Config::Set ("/NodeList/3/DeviceList/2/$ns3::WifiNetDevice/HeConfiguration/GuardInterval",
               TimeValue (NanoSeconds (giC)));
